 ...
 * @author baltamar3
 */
public class ListaPacientesAlergicos extends javax.swing.JDialog {

    String rutaP;

    /**
     * Creates new form ListaPacientesAlergicos
     */
    public ListaPacientesAlergicos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        pacientesAlergicos=Helper.listadoAlergicos(rutaP);
        Helper.llenarTablaPacientes(tblTablaPacientes, pacientesAlergicos);
    }
    ...
    private void initComponents() {
        ...
        setTitle("PACIENTES ALERGICOS");

        jPanel1.setBackground(new java.awt.Color(0, 102, 102));
        jPanel1.setPreferredSize(new java.awt.Dimension(930, 270));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("PACIENTES ALERGICOS");
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 910, 240));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/gota.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 60, 220, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaPacientesAlergicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaPacientesAlergicos dialog = new ListaPacientesAlergicos(new javax.swing.JFrame(), true);
